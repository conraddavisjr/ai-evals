...
export const ARCH = {
  ...
  nodes: [
    ...
    },
    {
      ...
      details: [
        'The consumer repo holds evals/stardust.config.json: target URL, body template, response map, datasets, judge questions, thresholds, budget.',
    ...
    // server
    {
      ...
      details: [
        ...
        'POST /api/ingest/runs (+ /:id/events, /:id/finish) takes a run recorded elsewhere (the target CLI, a CI job) as a live run: RunManager.startRecorded keeps an EventBus open so SSE viewers watch it, and the run is stored like any other. STARDUST_INGEST_TOKEN guards it on a hosted dashboard.',
