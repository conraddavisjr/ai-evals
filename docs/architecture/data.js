  ...
  nodes: [
    // client
    {
      ...
      details: [
        ...
        'Cases tab renders one waterfall per golden case ("Case 3 · <title>") with beat percentages; the persona is data, not the label.',
        ...
        'Inspector: linked views of a case (its full golden expectation, the expected tools per agent marked called / missing / unexpected, and what happened), a tool (description, scope, holders, input schema, every call in the run) and an agent (persona with Read more, tool slice, model, latency, usage, tool trail); a back stack between them. Case pills are verdicts: green when the outcome matches the expectation, red with a red case header when it deviates.',
    ...
    },
    {
      ...
      x: 1040,
      y: 770,
      title: 'Triage, action gate, review + judge',
      nick: 'the maître d’, the floor manager and the inspector',
      summary:
        'evaluate() at four decision points: door triage (and routing), the action gate, the orchestrator’s review, the judge.',
      details: [
